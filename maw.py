...
def get_info_magnit(url):
    cookies = {
        ...
        'domain_sid': 'nseMmFJjUQjKwjKEYK3iz%3A1780080030203',
        '_ym_isad': '2',
        '_ym_visorc': 'b',
        '__zzatw-magnit-rux': 'm39bSg==',
        'tmr_detect': '0%7C1780080031918',
        'gsscw-magnit-rux': 'TUzfxRsdQgNtigslQRALIqVYqku3ZeQjIYj5JuVn6jVInjQ305iOZiWDYQHXdc9zKgY1xeFZtsYAvNlAATPfi+i0jjJQ1nb2f/Yw2cYXLlvmkyDw6hrBUjcc7D+tPonfTD8XB/vWfxim2SRd80b43kfm4RNZjqkHaFAaM/aBSQ/oHZOHwcDLVv89nvZt7LeocfqDCKr91W9nrrmzt0NYz4HvS2fUGwZEcFKWMyT91FHYSRS3+i4j6rS6su9NZw==',
        'cfidsw-magnit-rux': 'GiSAlOF7yfN1ebhX2zunMu/ax0uWP0gfjMPjdBSJuGS18M78x+R7egJtfrZL+33gBLQkwJgq9ACBidikY5iwrbcyOFqjBSJX35B0bDTkyHdS31hK5c+SS/kFklx9cTv0pdr+V2ksjo4gtHsrFCoGJIN7Dr2b/nC54KdIJsE=',
        'cfidsw-magnit-rux': 'GiSAlOF7yfN1ebhX2zunMu/ax0uWP0gfjMPjdBSJuGS18M78x+R7egJtfrZL+33gBLQkwJgq9ACBidikY5iwrbcyOFqjBSJX35B0bDTkyHdS31hK5c+SS/kFklx9cTv0pdr+V2ksjo4gtHsrFCoGJIN7Dr2b/nC54KdIJsE=',
        'gsscw-magnit-rux': 'TUzfxRsdQgNtigslQRALIqVYqku3ZeQjIYj5JuVn6jVInjQ305iOZiWDYQHXdc9zKgY1xeFZtsYAvNlAATPfi+i0jjJQ1nb2f/Yw2cYXLlvmkyDw6hrBUjcc7D+tPonfTD8XB/vWfxim2SRd80b43kfm4RNZjqkHaFAaM/aBSQ/oHZOHwcDLVv89nvZt7LeocfqDCKr91W9nrrmzt0NYz4HvS2fUGwZEcFKWMyT91FHYSRS3+i4j6rS6su9NZw==',
        'uwyiert': '798377f9-973e-df63-e4e0-e69fbbdd5b06',
        'fgsscw-magnit-rux': 'rcUYd66369d8110f294e2f16a75743894a069179',
    }

    headers = {
        'accept': 'application/json',
        'accept-language': 'ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7',
        'baggage': 'sentry-environment=production,sentry-public_key=7992e659d14bf5d8da08d2e6a0706d0a,sentry-trace_id=117c0b42b480420eb8fa0e9fcaccdd9a,sentry-sampled=true,sentry-sample_rand=0.03833390703304196,sentry-sample_rate=0.05',
        ...
        'sentry-trace': '117c0b42b480420eb8fa0e9fcaccdd9a-99afa4d2f4dcbaea-1',
        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',
        'x-app-version': '2026.5.28-19.11',
        'x-client-name': 'magnit',
        'x-device-id': '4005c5a4-0d14-4e86-874d-ac3fdad8f75c',
        'x-device-platform': 'Web',
        'x-device-tag': 'disabled',
        'x-gib-fgsscw-magnit-rux': 'rcUYd66369d8110f294e2f16a75743894a069179',
        'x-gib-gsscw-magnit-rux': 'TUzfxRsdQgNtigslQRALIqVYqku3ZeQjIYj5JuVn6jVInjQ305iOZiWDYQHXdc9zKgY1xeFZtsYAvNlAATPfi+i0jjJQ1nb2f/Yw2cYXLlvmkyDw6hrBUjcc7D+tPonfTD8XB/vWfxim2SRd80b43kfm4RNZjqkHaFAaM/aBSQ/oHZOHwcDLVv89nvZt7LeocfqDCKr91W9nrrmzt0NYz4HvS2fUGwZEcFKWMyT91FHYSRS3+i4j6rS6su9NZw==',
        'x-new-magnit': 'true',
        'x-platform-version': 'Windows Chrome 148',
        # 'cookie': 'mg_udi=4005c5a4-0d14-4e86-874d-ac3fdad8f75c; nmg_dt=; x_shop_type=ME; _ym_uid=1776537710143112713; _ym_d=1776537710; oxxfgh=8219b48f-e802-466b-87d5-66e2ccf6b4d7%230%237884000000%235000%231800000%2312840; uwyii=2a42fc6c-2596-bc2b-af14-ed80b291dff8; nmg_sp=Y; mg_uac=1; shopCode=%22992301%22; tmr_lvid=6f78a3c1e1cb800fbb78f4a6dcb68cbb; tmr_lvidTS=1778929623484; domain_sid=nseMmFJjUQjKwjKEYK3iz%3A1780080030203; _ym_isad=2; _ym_visorc=b; __zzatw-magnit-rux=m39bSg==; tmr_detect=0%7C1780080031918; gsscw-magnit-rux=TUzfxRsdQgNtigslQRALIqVYqku3ZeQjIYj5JuVn6jVInjQ305iOZiWDYQHXdc9zKgY1xeFZtsYAvNlAATPfi+i0jjJQ1nb2f/Yw2cYXLlvmkyDw6hrBUjcc7D+tPonfTD8XB/vWfxim2SRd80b43kfm4RNZjqkHaFAaM/aBSQ/oHZOHwcDLVv89nvZt7LeocfqDCKr91W9nrrmzt0NYz4HvS2fUGwZEcFKWMyT91FHYSRS3+i4j6rS6su9NZw==; cfidsw-magnit-rux=GiSAlOF7yfN1ebhX2zunMu/ax0uWP0gfjMPjdBSJuGS18M78x+R7egJtfrZL+33gBLQkwJgq9ACBidikY5iwrbcyOFqjBSJX35B0bDTkyHdS31hK5c+SS/kFklx9cTv0pdr+V2ksjo4gtHsrFCoGJIN7Dr2b/nC54KdIJsE=; cfidsw-magnit-rux=GiSAlOF7yfN1ebhX2zunMu/ax0uWP0gfjMPjdBSJuGS18M78x+R7egJtfrZL+33gBLQkwJgq9ACBidikY5iwrbcyOFqjBSJX35B0bDTkyHdS31hK5c+SS/kFklx9cTv0pdr+V2ksjo4gtHsrFCoGJIN7Dr2b/nC54KdIJsE=; gsscw-magnit-rux=TUzfxRsdQgNtigslQRALIqVYqku3ZeQjIYj5JuVn6jVInjQ305iOZiWDYQHXdc9zKgY1xeFZtsYAvNlAATPfi+i0jjJQ1nb2f/Yw2cYXLlvmkyDw6hrBUjcc7D+tPonfTD8XB/vWfxim2SRd80b43kfm4RNZjqkHaFAaM/aBSQ/oHZOHwcDLVv89nvZt7LeocfqDCKr91W9nrrmzt0NYz4HvS2fUGwZEcFKWMyT91FHYSRS3+i4j6rS6su9NZw==; uwyiert=798377f9-973e-df63-e4e0-e69fbbdd5b06; fgsscw-magnit-rux=rcUYd66369d8110f294e2f16a75743894a069179',
    }
...
def get_info_lenta(url):
    cookies = {
        ...
        'Utk_MrkGrpTkn': '17DEBD299B9C8C931345B732C400E86A',
        'acs_3': '%7B%22hash%22%3A%221aa3f9523ee6c2690cb34fc702d4143056487c0d%22%2C%22nst%22%3A1780141446815%2C%22sl%22%3A%7B%22224%22%3A1780055046815%2C%221228%22%3A1780055046815%7D%7D',
        'adrdel': '1780055047039',
        '_ym_isad': '2',
        'domain_sid': '4vtd8s78bmtXLwu3dinrB%3A1780055048839',
        'qrator_jsid': '1780055043.599.hVg8jqsFjdiuoqnH-7mau2n483u4oo366mi9481gl3f0c8q64',
        'Utk_DvcGuid': '997a1728-43a1-19c8-040a-fcaf2509b38b',
        ...
        'spses.d58d': '*',
        '_ym_visorc': 'b',
        'tmr_detect': '0%7C1780073664375',
        'spid.d58d': '0d5a2eb8-df14-418e-ba33-e23583159a75.1777142065.14.1780073681.1780070729.8165d82c-5f2e-4a42-b390-0e58c980fc7e.026c307e-5b4c-4e92-b22e-21a5c7cb1764.958dd661-dd88-4247-81aa-6d30f2529905.1780073179095.299',
    }
    ...
    headers = {
        ...
        'traceparent': '00-044813cd003c54dd480f946ff2e346dc-4fe7329663a27346-01',
        'user-agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36',
        'x-delivery-mode': 'pickup',
        'x-device-brand': '',
        'x-device-id': '997a1728-43a1-19c8-040a-fcaf2509b38b',
        'x-device-name': '',
        'x-device-os': 'Web',
        ...
        'x-platform': 'omniweb',
        'x-retail-brand': 'lo',
        'x-span-id': '4fe7329663a27346',
        'x-trace-id': '044813cd003c54dd480f946ff2e346dc',
        'x-user-session-id': 'e578272b-f819-9908-9829-c390121c1c99',
        # 'cookie': 'GrowthBook_user_id=fdf99ea2-b311-7e97-c3ff-75bb427460c7; PassportRefreshToken=; PassportAccessToken=; PassportExpiresIn=; UserSessionId=e578272b-f819-9908-9829-c390121c1c99; Utk_SessionToken=01FA44FD85685B724BBC5E4D93362E1E; iap.uid=f2e2bc5792b84e86805fac78a8c7ad40; App_Cache_MissionAddressMode=%7B%22t%22%3A%22pickup%22%2C%22ids%22%3Atrue%2C%22ma%22%3A%7B%22i%22%3A3149%2C%22a%22%3A%220124%22%2C%22t%22%3A%22%D0%A2%D0%9A124%22%2C%22af%22%3A%22%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0%2C%207-%D1%8F%20%D0%9A%D0%BE%D0%B6%D1%83%D1%85%D0%BE%D0%B2%D1%81%D0%BA%D0%B0%D1%8F%20%D1%83%D0%BB%D0%B8%D1%86%D0%B0%2C%209%20(%D0%A2%D0%A0%D0%A6%20%D0%9C%D0%BE%D0%B7%D0%B0%D0%B8%D0%BA%D0%B0)%22%2C%22ri%22%3A1%2C%22mt%22%3A%22HM%22%2C%22s%22%3Afalse%7D%7D; flocktory-uuid=c23b42bd-b510-4a3a-b22d-da4458c83842-5; tmr_lvid=35f569253036a15cf7e71521dbc75886; tmr_lvidTS=1777142063632; adrcid=AV4RKMBCoarA8ah9OIqjerg; _ym_uid=1777142064325930018; _ym_d=1777142064; agree_with_cookie=true; _bge_ci=BA1.1.7794651279.1779214316; _bge_uid2=8141640746625702563; GrowthBook_Cookie_Experiments=exp_newui_chips.test%2C%20exp_web_chips_online.test%2C%20exp_big_card.test%2C%20exp_without_a_doorbell.test_A%2C%20exp_new_navigation_web.test%2C%20exp_web_mobile_tabbar.test%2C%20exp_web_personal_promo_delivery_chips.test%2C%20exp_new_navigation_web_search.test%2C%20exp_new_navigation_web_actions.test%2C%20exp_leave_order_at_door.test%2C%20exp_leave_order_at_door_new.test%2C%20exp_new_counter_web.test; GrowthBook_experiments=experiment_web_cl_new_csi_v2.0%2Cexperiment_web_aa_test_202601.0%2Cexperiment_web_aa_2026_01_v1.0%2Cexperiment_web_delivery_after_promocode_v2.1; App_Cache_MPK=mp300-b1de0bac2c257f3257bf5ef2eea4ecbc; App_Cache_CitySlug=moscow; App_Cache_City=%7B%22centerLat%22%3A%2255.75322%22%2C%22centerLng%22%3A%2237.622552%22%2C%22id%22%3A1%2C%22isDefault%22%3Atrue%2C%22mainDomain%22%3Afalse%2C%22name%22%3A%22%D0%9C%D0%BE%D1%81%D0%BA%D0%B2%D0%B0%20%D0%B8%20%D0%9C%D0%9E%22%2C%22slug%22%3A%22moscow%22%7D; Utk_MrkGrpTkn=17DEBD299B9C8C931345B732C400E86A; acs_3=%7B%22hash%22%3A%221aa3f9523ee6c2690cb34fc702d4143056487c0d%22%2C%22nst%22%3A1780141446815%2C%22sl%22%3A%7B%22224%22%3A1780055046815%2C%221228%22%3A1780055046815%7D%7D; adrdel=1780055047039; _ym_isad=2; domain_sid=4vtd8s78bmtXLwu3dinrB%3A1780055048839; qrator_jsid=1780055043.599.hVg8jqsFjdiuoqnH-7mau2n483u4oo366mi9481gl3f0c8q64; Utk_DvcGuid=997a1728-43a1-19c8-040a-fcaf2509b38b; User_Agent=Mozilla%2F5.0%20(Windows%20NT%2010.0%3B%20Win64%3B%20x64)%20AppleWebKit%2F537.36%20(KHTML%2C%20like%20Gecko)%20Chrome%2F148.0.0.0%20Safari%2F537.36; Is_Search_Bot=false; spses.d58d=*; _ym_visorc=b; tmr_detect=0%7C1780073664375; spid.d58d=0d5a2eb8-df14-418e-ba33-e23583159a75.1777142065.14.1780073681.1780070729.8165d82c-5f2e-4a42-b390-0e58c980fc7e.026c307e-5b4c-4e92-b22e-21a5c7cb1764.958dd661-dd88-4247-81aa-6d30f2529905.1780073179095.299',
    }

    json_data = {
        'query': 'тархун черноголовка 1л',
        'filters': {
            'checkbox': [],
            'multicheckbox': [],
            'range': [],
